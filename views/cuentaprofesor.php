...
<div class="container">
    ...
    <form action="?controlador=Profesor&accion=actualizar_datos" name="Datos Personales" method="post" autocomplete= "off" ">
    <td><input name="id" type = "hidden" value="<?php echo $datos['id']; ?>"></td>
    <table>
    <tr>
		<td>Nombres:</td>
	...
	<tr>
		<td>Apellidos:</td>
		<td><input type="text" name="apellidos" id="apellidos" value="<?php echo $datos['apellidos']; ?>"</td>
	</tr>
     ...
     <tr>
		<td>Celular:</td>
		<td><input id="celular" name="celular" type = "tel" pattern="[0-9]{8}" size="10" value="<?php echo $datos['celular']; ?>"></td>
	</tr>
	<tr>

    <tr>
		<td>Email:</td>
		<td><input id="email" name="email" type = "email" pattern=".+\@.+\..+" size="30" value="<?php  $datos['email'];?>"></td>
	</tr>
	<tr>

    <tr>
		<td>Foto:</td>
		<td><input id="foto" name="email" type = "image" size="30" src="public/img/avatar.gif"></td>
	</tr>
	<tr>
        ...
        <div id="tab2" class="tab_content">
            <form  name="datos_academicos" method="post" autocomplete= "off" ">
    <table>
    <tr>
		<td>Profesi&oacute;n:</td>
		<td><input id="profesion" name="profesion" type = "text" size="30" value="<?php $carrera['profesion'] ?>"></td>
	</tr>
	<tr>
		<td>Instituci&oacute;n:</td>
		<td><input id="institucion" name="institucion" type = "text" pattern="[0-9]{7}[-]{1}[0-9]{1}" size="10" value="<?php /*echo $rol; */?>"></td>
	</tr>
	<tr>
		<td><input type="reset" value="Restablecer"></td>
		<td></td>
