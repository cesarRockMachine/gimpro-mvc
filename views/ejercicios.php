...
<style type="text/css">
    ...
    #EjercicioForm {
        height: 277px;
        width: 351px;
        /*   background-image: url('public/img/bkg.jpg');*/
        display: none;
    }

    #EjercicioForm fieldset {
        padding: 30px;
        border: none;
    }
    ...
    #EjercicioForm input[type=submit] {
...
<div id="box">
    <div id="addEjercicioFormContainer">
        <div id="EjercicioForm">
            <fieldset>
                <form id="sendejercicio" action="" method="POST">
                    ...
                    <input id="link" placeholder="tipo->http://www.youtube.com/watch?v=cl0IlD4qLUM" required
                           type="text"/>
        ...
        <div id="contactLink"><input type="submit" value="Agregar Ejercicio"></input></div>
    </div>
</div>
